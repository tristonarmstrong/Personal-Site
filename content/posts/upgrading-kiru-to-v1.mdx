...
The most massive change dropping in Kiru v1 is an entirely new reactive paradigm. Gone are the days of the React-like hooks API. The maintainers have wiped out `useState`, `useEffect`, and `useMemo`. 
