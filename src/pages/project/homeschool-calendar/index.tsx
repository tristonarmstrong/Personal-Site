  ...
  return (
    <article>
      <header>
        ...
        <h1 style={`view-transition-name: link-h-homeschoolcalendar`} className={"text-2xl font-bold"}>HomeSchool Calendar</h1>
      </header>
      <code>unimplimented!()</code>
      <p>in the meantime heres the link to the repo:</p>
      <a target={"_blank"} className={"text-yellow-500"} href="https://github.com/tristonarmstrong/homeschool-planner.git">HomeSchool Calendar</a>
    </article>
  )
}
